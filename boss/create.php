 ...
 <!-- alert message for status of form submission -->
  ...
  <form class="form w-50" method="post">
   <div class="form-group">
    ...
    <input class="form-control form-control-lg" type="text" name="test_date" id="test_date" placeholder="xx-xx-xxxx">
    </div>

     <div class="form-group">
    <label class="h5 font-weight-bold" for="DOB">Date Of Birth</label>
    <input class="form-control form-control-lg" type="text" name="DOB" id="DOB" placeholder="xx-xx-xxxx">
    </div>
